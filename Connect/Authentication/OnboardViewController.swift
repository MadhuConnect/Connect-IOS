...
//    var descs = ["Lorem ipsum dolor sit amet, consectetur adipiscing elit.","Lorem ipsum dolor sit amet, consectetur adipiscing elit.","Lorem ipsum dolor sit amet, consectetur adipiscing elit."]
    var imgs = ["intro-img1","intro-img2","intro-img3","intro-img4","intro-img5"]
    ...
    override func viewDidLoad() {
        ...
        for index in 0..<imgs.count {
            ...
            imageView.frame = view.bounds//CGRect(x: 0, y: 0, width: view.frame.width, height: view.frame.height)
...
//        }
    ...
    @IBAction func nextAction(_ sender: UIButton) {
        ...
        case 2:
            ...
            btnNext.setTitle("Next", for: .normal)
        case 3:
            scrollToPage(page: 4, animated: true)
